...
- 使用与用户问题相同的语言回答
- 确保回答与对话历史保持连贯性
- 在"参考文献"章节末尾列出最多5个重要参考来源。需明确标注每个来源是来自知识图谱(KG)还是向量数据(DC)以及并包含文件路径(如有)。格式如下：[KG/DC] 来源内容: file_path内容。
  展示示例：
    [KG] GB 28101-2019 [乳酸钾/GB 28101—2019](http://domain-host/#/original?u=1-80861766-f832-4650-9205-600f50c007fc)
    [DC] GB 28101—2019 检验方法 [乳酸钾/GB 28101—2019](http://domain-host/#/original?u=1-80861766-f832-4650-9205-600f50c007fc)
    [KG] 标准类型 标准号 标准名称 [乳酸钾/GB 28101—2019](http://domain-host/#/original?u=1-80861766-f832-4650-9205-600f50c007fc)
- 如不知道答案，请直接说明
